...
sys.path.append('/kaggle/working/audio-super-res/src')
      ...
      for line in f:
        try:
          ...
          if(args.speaker == 'single'):
            upsample_wav('/kaggle/input/english-multispeaker-corpus-for-voice-cloning/VCTK-Corpus/VCTK-Corpus/wav48/p225/'+line.strip(), args, model)
          else:
            upsample_wav('/kaggle/input/english-multispeaker-corpus-for-voice-cloning/VCTK-Corpus/VCTK-Corpus/'+line.strip(), args, model)
        except EOFError:
